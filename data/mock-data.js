...
const ASTERAHR = {
  ...
  permissions: {
    ...
    it_admin: {
      ...
      attendance: { view:0, create:0, edit:0, delete:0, approve:0 },
  ...
  moduleData: {
    ...
    attendance: [
      { userId:'USR-004', name:'Grace Achieng', event:'Check-in recorded', status:'08:01 AM', context:'Head office', dept:'Engineering', issue:false },
      { userId:'USR-004', name:'Grace Achieng', event:'Correction submitted', status:'Pending', context:'Missing checkout', dept:'Engineering', issue:true },
      { userId:'USR-003', name:'James Otieno', event:'Late arrival', status:'Open', context:'09:17 AM', dept:'Engineering', issue:true },
      { userId:'USR-003', name:'Mercy Wanjiku', event:'Remote check-in', status:'Completed', context:'07:48 AM', dept:'Engineering', issue:false },
      { userId:'USR-003', name:'Daniel Kariuki', event:'Missing checkout', status:'Pending', context:'Yesterday', dept:'Engineering', issue:true },
      { userId:'USR-002', name:'Amina Odhiambo', event:'Remote check-in', status:'07:46 AM', context:'HR Office', dept:'HR', issue:false },
      { userId:'USR-001', name:'John Mwangi', event:'On-site check-in', status:'07:39 AM', context:'Head office', dept:'HR', issue:false },
    ],
    leave: [
    ...
    training: [
      { userId:'USR-004', name:'Grace Achieng', course:'Data privacy refresh', status:'Completed', context:'Recorded', dept:'Engineering', required:true },
      { userId:'USR-004', name:'Grace Achieng', course:'Leadership webinar', status:'Scheduled', context:'Friday', dept:'Engineering', required:false },
      ...
      { userId:'USR-003', name:'Mercy Wanjiku', course:'Leadership session', status:'Scheduled', context:'Engineering', dept:'Engineering', required:false },
      { userId:'USR-002', name:'Amina Odhiambo', course:'Labour law refresher', status:'Completed', context:'HR', dept:'HR', required:true },
    ],
    documents: [
